...
<div class="scene events i:event red">
	...
	<ul class="items">
		<li class="item">
			<h3>Dukkepartiet til Folkemøde</h3>
			<dl class="info">
				<dt class="published_at">Tidspunkt</dt>
				<dd class="published_at"><span class="date">12.06.14</span> — <span class="time">10:00</span></dd>
				<dt class="location">Sted</dt>
				<dd class="location">Bornholm</dd>
			</dl>
			<div class="description">
				<p>Dukkepartiet leder efter folket</p>
			</div>
		</li>
	</ul>

	<ul class="actions">
<li class="previous"><a href="/kalender/40">Forrige</a></li><li class="next"><a href="/kalender/75">Næste</a></li>	</ul>
