...
<div class="scene events i:event red">
	...
	<ul class="items">
		<li class="item">
			<h3>Dukkepartiet Danmarksturné Stop#7</h3>
			<dl class="info">
				<dt class="published_at">Tidspunkt</dt>
				<dd class="published_at"><span class="date">24.10.14</span> — <span class="time">15:00</span></dd>
				<dt class="location">Sted</dt>
				<dd class="location">Svendborg - Torvet</dd>
			</dl>
	...
	<ul class="actions">
<li class="previous"><a href="/kalender/99">Forrige</a></li><li class="next"><a href="/kalender/101">Næste</a></li>	</ul>
