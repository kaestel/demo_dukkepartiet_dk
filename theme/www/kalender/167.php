...
<div class="scene events i:event red">
	...
	<ul class="items">
		<li class="item">
			<h3>Dukkepartiets Partifest</h3>
			<dl class="info">
				<dt class="published_at">Tidspunkt</dt>
				<dd class="published_at"><span class="date">28.11.14</span> — <span class="time">16:00</span></dd>
				<dt class="location">Sted</dt>
				<dd class="location">Sort/Hvid - Skindergade 3, Kbh. K.</dd>
			</dl>
			<div class="description">
				<p>Dukkepartiet køber vælgererklæringer for øl. Mød dukkerne og tag del i de spændende aktiviteter.</p>
			</div>
		</li>
	</ul>

	<ul class="actions">
<li class="previous"><a href="/kalender/101">Forrige</a></li>	</ul>
