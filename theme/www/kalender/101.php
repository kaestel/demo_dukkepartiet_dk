...
<div class="scene events i:event red">
	...
	<ul class="items">
		<li class="item">
			<h3>Dukkepartiet danmarksturné stop#8</h3>
			<dl class="info">
				<dt class="published_at">Tidspunkt</dt>
				<dd class="published_at"><span class="date">25.10.14</span> — <span class="time">11:00</span></dd>
				<dt class="location">Sted</dt>
				<dd class="location">Nykøbing Falster - Torvet</dd>
			</dl>
			<div class="description">
				<p>Dukkepartiet drager i oktober måned landet rundt for at finde Dukkepartiets kommende statsministerkandidat. Karavanen starter i København og rejser herefter til Helsingør, Århus, Aalborg, Kolding, Odense, Svendborg og Nykøbing Falster. Dukkepartiet opfordrer almindelige borgere til at forsøge sig som statsminister. I valgbussen kan man blandt andet prøve kræfter med Folketingets talerstol og tage ”Politikerledetesten”.  Det hele krydres med indslag af dukker fra Dukkepartiet. De bedste kandidater går videre til Statsministerdysten, der findes ved Den Store Finale på Teater Nordkraft i Aalborg den 8. november.</p>
			</div>
		</li>
	</ul>

	<ul class="actions">
<li class="previous"><a href="/kalender/100">Forrige</a></li><li class="next"><a href="/kalender/167">Næste</a></li>	</ul>
