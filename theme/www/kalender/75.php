...
<div class="scene events i:event red">
	...
	<ul class="items">
		<li class="item">
			<h3>Dukkepartiet til kulturmøde</h3>
			<dl class="info">
				<dt class="published_at">Tidspunkt</dt>
				<dd class="published_at"><span class="date">22.08.14</span> — <span class="time">10:30</span></dd>
				<dt class="location">Sted</dt>
				<dd class="location">MORS</dd>
			</dl>
			<div class="description">
				<p>Dukkepartiet søger statsministerkandidater.</p>
			</div>
		</li>
	</ul>

	<ul class="actions">
<li class="previous"><a href="/kalender/76">Forrige</a></li><li class="next"><a href="/kalender/83">Næste</a></li>	</ul>
