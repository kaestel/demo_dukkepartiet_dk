...
<div class="scene events i:event red">
	...
	<ul class="items">
		<li class="item">
			<h3>Dukkepartiet Danmarksturné Stop#3</h3>
			<dl class="info">
				<dt class="published_at">Tidspunkt</dt>
				<dd class="published_at"><span class="date">10.10.14</span> — <span class="time">15:00</span></dd>
				<dt class="location">Sted</dt>
				<dd class="location">Aarhus - Lille Torv</dd>
			</dl>
	...
	<ul class="actions">
<li class="previous"><a href="/kalender/95">Forrige</a></li><li class="next"><a href="/kalender/97">Næste</a></li>	</ul>
