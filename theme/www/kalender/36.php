...
<div class="scene events i:event red">
	...
	<ul class="items">
		<li class="item">
			<h3>Dukkepartiet Aktion #2</h3>
			<dl class="info">
				<dt class="published_at">Tidspunkt</dt>
				<dd class="published_at"><span class="date">08.04.14</span> — <span class="time">13:00</span></dd>
				<dt class="location">Sted</dt>
				<dd class="location">Christiansborg Slotsplads</dd>
			</dl>
			<div class="description">
				<p>Kom og bliv dukke.</p>
			</div>
		</li>
	</ul>

	<ul class="actions">
<li class="next"><a href="/kalender/38">Næste</a></li>	</ul>
